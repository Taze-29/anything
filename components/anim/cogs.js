...
export default function Cogs() {
  return (
    <div className="flex flex-col bg-red-200 rounded-lg rounded-tr-[200px] justify-start items-center h-[100%] pt-[10%]">
      <div
        className="cog"
        style={{          
        }}
      ...
      <div
        className="ml-[50px] mt-[45px] cogReverse"
        style={{}}
      >
        <svg           
      ...
      <div        
        className="mt-[95px] mr-[105px] cog"
        style={{transform: ""}}
      >
        <svg       
          className="scale-[2.5]"
