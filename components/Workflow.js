...
const data = [
  {
    ...
    icon: <FaMagnifyingGlass className="w-full h-full p-4 lg:p-20 text-slate-800" />,
    color: "bg-[#5eead4]"  
  },
  {
    num: "02",
    ...
    icon: <FaWandMagicSparkles className="w-full h-full p-4 lg:p-20 text-slate-800" />,
    color: "bg-indigo-300"  
  },
  {
    num: "03",
    ...
    icon: <FaCode className="w-full h-full p-4 lg:p-20 text-slate-800" />,
    color: "bg-blue-300"  
  },
  {
    num: "04",
    ...
    icon: <GiVial className="w-full h-full p-4 lg:p-20 text-slate-800" />,
    color: "bg-yellow-300"  
  },
  {
    num: "05",
    ...
    icon: <FaRocket className="w-full h-full p-4 lg:p-20 text-slate-800" />,
    color: "bg-green-300"  
  }
];
...
const WorkflowCard = ({ num, title, description, src, icon, color }) => {
  return (
    <div className="w-[80vw] lg:w-[1000px] h-[350px] lg:h-[400px] flex bg-white justify-between rounded-lg">
      <div className="flex flex-col gap-4 lg:gap-16 w-[600px] p-8">
        ...
        <div className="flex justify-between">
          ...
          <div className={`lg:hidden w-1/3 h-full rounded-lg ${color}`}>
            {icon}
          </div>
        </div>
      ...
      <div className="hidden lg:flex justify-center items-center m-4 w-[400px]">
...
const Arrow = () => {
  return (
    <div className="h-full flex justify-center items-center text-5xl p-8 lg:p-16 text-white">
      <GoArrowRight />
    </div>
  )
}
  ...
  return (
    <>
      <div className="w-full bg-[#121212]">
        ...
        >
          <div className="sticky top-0 h-screen flex flex-col items-start justify-center -mx-8 lg:-mx-32 bg-[#121212] overflow-hidden">
            <h2 className="text-2xl lg:text-7xl mt-[20px] lg:mt-0 lg:mb-8 px-4 lg:px-32 text-white">OUR DEVELOPMENT PROCESS</h2>
            <div className="px-8 py-4 lg:p-16">
              <motion.div
